...
CSS-nya pecah menjadi screen_style.py (browser/HP) dan print_style.py
...
Kontrak lama tetap dijaga lewat re-export:
  ...
  from worksheets import lembar_soal, lembar_penilaian, tulis, CSS
...
# gaya cetak. Tampilan layar ada di screen_style.GAYA_LAYAR.
from print_style import GAYA_CETAK as CSS  # noqa: F401
