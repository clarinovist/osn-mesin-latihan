"""Identitas refactor Fase A: kode baru wajib mereproduksi kode lama.

Tanda tangan lembar & soal di bawah dicetak dari kode PRA-refactor
(buat_emas.py, 28 Aug 2026). Refactor paket topik adalah pemindahan kode,
bukan perubahan perilaku: seed yang sama harus menghasilkan soal yang sama
persis — parameter, kunci, malrule — supaya bank soal dan diagnosis lama di
latihan.db tetap konsisten.

Kalau test ini gagal setelah refactor, perilaku berubah — cari kenapa,
...
EMAS = {
 ...
 "soal": {
  ...
  "P3|siklus_huruf|7": "P3|siklus_huruf(pola=ABCBE,posisi=20)",
  "P3|siklus_warna|7": "P3|siklus_warna(pola=kuning,biru,kuning,merah,putih,posisi=38)",
  "P3|sisa_bagi_siklus|7": "P3|sisa_bagi_siklus(pola=ABCBE,posisi=60)",
  ...
  "P4|siklus_huruf|7": "P4|siklus_huruf(pola=ABCBE,posisi=35)",
  "P4|siklus_warna|7": "P4|siklus_warna(pola=kuning,biru,kuning,merah,putih,posisi=77)",
  "P4|sisa_bagi_siklus|7": "P4|sisa_bagi_siklus(pola=ABCBE,posisi=86)",
  ...
  "P5|siklus_huruf|7": "P5|siklus_huruf(pola=ABCBE,posisi=70)",
  "P5|siklus_warna|7": "P5|siklus_warna(pola=kuning,biru,kuning,merah,putih,posisi=149)",
  "P5|sisa_bagi_siklus|7": "P5|sisa_bagi_siklus(pola=ABCBE,posisi=162)",
  ...
  "P6|siklus_huruf|7": "P6|siklus_huruf(pola=ABCBE,posisi=120)",
  "P6|siklus_warna|7": "P6|siklus_warna(pola=kuning,biru,kuning,merah,putih,posisi=269)",
  "P6|sisa_bagi_siklus|7": "P6|sisa_bagi_siklus(pola=ABCBE,posisi=633)",
...
def test_lembar_identik_dengan_kode_pra_refactor(level, seed):
    kunci = EMAS["lembar"][f"{level}|{seed}"]
    assert buat_lembar(seed, level=level).tanda_tangan == kunci


@pytest.mark.parametrize("level", LEVEL)
def test_setiap_template_identik_dengan_kode_pra_refactor(level):
